...
<body>
 ...
 <header class="header">
  ...
  <!-- Success Student -->
<div class="container">
    <h2 class="main-title" style="text-align:center; margin-bottom: 18px; margin-top: 18px;"><span style="color:#ff6810;">Success</span> Student</h2>
    <div class="container" style="display: flex; flex-wrap: wrap;">
      @foreach ($data as $data)
      <div class="box">
       <div class="box1">
         <div class="box_item">
          <img src="Success_Student/{{ $data->image }}" class="card-img-top" alt="...">
          <div class="card-body">
