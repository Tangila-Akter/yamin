...
<html lang="en">
  ...
  <body>
    ...
    <div style="position: relative; top:60px; right:-150px;">
        ...
        <form action="{{ url('/update_All_Teacher',$data->id) }}" method="post" enctype="multipart/form-data">
            @csrf
        ...
        <div>
         ...
         <input type="text" class="text" name="YouTube" value="{{ $data->YouTube }}" >
           ...
           <div>
               ...
               <img height="200" width="200" src="All_Teacher/{{ $data->image }}" hidden >
           </div>
           ...
           <div>
            ...
            margin: 1px;
            padding: 7px;
            border-radius: 5px;" type="submit" href="{{ url('/admin_All_Teacher') }}">Go Back </a>
        </div>
        </form>
       </div>
    </div>
