...
<html lang="en">
  ...
  <body>
    ...
    <div style="position: relative; top:60px; right:-150px;">
        <form action="{{ url('/update_Video_Course',$data->id) }}" method="post" enctype="multipart/form-data">
            @csrf
           ...
           <div>
               ...
               <img height="200" width="200" src="video_Course/{{ $data->image }}" hidden >
           </div>
           ...
           <div>
            ...
            margin: 1px;
            padding: 7px;
            border-radius: 5px;" type="submit" href="{{ url('/admin_Video_Course') }}">Go Back </a>
        </div>
        </form>
       </div>
    </div>
