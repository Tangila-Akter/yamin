...
<html lang="en">
  ...
  <body>
    ...
    <div style="position: relative; top:60px; right:-150px;">
        ...
        <form action="{{ url('/update_Web_Team',$data->id) }}" method="post" enctype="multipart/form-data">
            @csrf
        ...
        <div>
         ...
         <input type="text" class="text" name="YouTube" value="{{ $data->YouTube }}" >
           ...
           <div>
               ...
               <img height="200" width="200" src="Web_Team/{{ $data->image }}" hidden >
           </div>
           ...
           <div>
            ...
            margin: 1px;
            padding: 7px;
            border-radius: 5px;" type="submit" href="{{ url('/admin_Web_Team') }}">Go Back </a>
        </div>
        </form>
       </div>
    </div>
